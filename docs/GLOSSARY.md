...
**Prompt bank** ที่เก็บ embedding สะสมของทุกคลาสที่ผู้ใช้เคย label ไว้ด้วยมือ เก็บที่ `<input_dir>/.ctflow/_bank/` ยิ่งสะสมมาก โมเดลยิ่งแยกแยะคลาสนั้นได้แม่นขึ้น (implement เป็น class `Bank` ใน `services/bank.py`)
