...
วันนี้ CT-Flow ไม่มีแนวคิด "โปรเจกต์" ในสายตาผู้ใช้ — โฟลเดอร์ภาพ *คือ* โปรเจกต์ และ path ของมันถูกจำไว้ใน `localStorage` ของ browser คนที่เปิด ผลคือ:
...
Phase 2 แก้สี่ข้อนี้ **ไม่แก้อย่างอื่น**
