...
| FR-19 | **Pre-annotation: แสดงกล่องที่โมเดลทำนายไว้ล่วงหน้าตอนผู้ใช้เปิดภาพเพื่อ label** | ✅ | `POST /api/predict` · กล่องร่างเส้นประ + ปุ่ม "Use them" (คีย์ A) · bank ว่าง = ไม่เรียก · ~0.4 วิ/ภาพ (เรียกแรกของ process ~8 วิ ตอน warm-up) |
