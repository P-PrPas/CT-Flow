...
//
// Ported from backend/services/annotations_db.py and services/db.py. The SQL is
...
// by the inference sidecar -- see backend/services/bank.py.
//
...
// SchemaPath is backend/schema.sql -- the same file the Python service runs,
